...
//1151607/1146958/2.50/4/2/Connector
...
(library Library_1
	...
	(patternDef "43650-04YY_272829" (originalName "43650-04YY_272829")
		(multiLayer
	...
	(symbolDef "43650-0428" (originalName "43650-0428")
	...
	(compDef "43650-0428" (originalName "43650-0428") (compHeader (numPins 4) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "43650-0428"))
		(attachedPattern (patternNum 1) (patternName "43650-04YY_272829")
			(numPads 4)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "43650-0428")
		(attr "Mouser Part Number" "538-43650-0428")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Molex/43650-0428?qs=zhePCb1yaFNxbtO8xFE5bw%3D%3D")
		...
		(attr "<Hyperlink>" "https://www.molex.com/pdm_docs/sd/436500227_sd.pdf")
		(attr "<Component Height>" "9.9")
		(attr "<STEP Filename>" "43650-0428.stp")
		(attr "<STEP Offsets>" "X=-4.48;Y=0;Z=4.82")
